...
# Add label
lbl_classifier = tk.Label(text="Select a Classifier: ",
                          fg="navy",
                          anchor="w",
                          width=25,
                          height=1,
...
rb_knn = tk.Radiobutton(text="K-Nearest Neighbor",
...
rb_svc = tk.Radiobutton(text="Support Vector Classification",
                        variable=classifier_name,
                        value='svc',
                        font=myFont,
                        command=select_classifier)
...
# Label to display output when button is clicked
lbl_selected_classifier = tk.Label(text="",
                                   fg="navy",
                                   width=25,
                                   height=1,
                                   font=myFont)
